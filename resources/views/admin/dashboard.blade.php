    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h5 class="title">Kelompok 1 UMKM</h5>
        ...
        {{-- <div class="card-body">
          ...
          <div class="typography-line">
            <h5><span></span>Rizki Ahmad Fauzi : Frontend </h5>
          </div>
          <div class="typography-line">
            <h5><span></span>Muhammad Fatih : Backend </h5>
          </div>
          <div class="typography-line">
            <h5><span></span>Yogi Dastio : Presentasi </h5>
          </div>
          <div class="typography-line">
            <h5><span></span>Ahmadin : Presentasi </h5>
          </div>
          {{-- <div class="typography-line">
