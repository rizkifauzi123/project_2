      ...
      <div class="col-md-12">
        <div class="card card-user">
          <div class="card-header">
            <h5 class="card-title">Buat Produk Baru</h5>
          </div>
          <div class="card-body">
            ...
            @endif
            <form action="{{ url('/dashboard/produk/store')}}" method="POST">
                @csrf
              <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                      <label>Nama Produk Baru</label>
                      <input type="text" class="form-control" id="nama" name="nama" placeholder="* Masukan Nama Produk Makanan Baru">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
